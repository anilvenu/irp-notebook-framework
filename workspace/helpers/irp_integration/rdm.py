...
from .constants import EXPORT_JOB
...
class RDMManager:
    ...
    def export_analyses_to_rdm(self, rdm_name: str, analysis_ids: list) -> dict:
        ...
        response = self.client.execute_workflow('POST', EXPORT_JOB, json=data, headers={"x-rms-resource-group-id": os.environ.get('RISK_MODELER_RESOURCE_GROUP_ID')})
