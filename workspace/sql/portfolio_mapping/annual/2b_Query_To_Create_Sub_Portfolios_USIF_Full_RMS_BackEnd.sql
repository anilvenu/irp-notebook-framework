...
select max(portinfoid)+1,'USIF_Full_Lender_P','USIF_Full_Lender_P',@Date,'USIF_Full_Lender_P'
 from dbo. Portinfo
...
insert into dbo.Portinfo (PORTINFOID,PORTNUM,PORTNAME,CREATEDATE,DESCRIPT)
select max(portinfoid)+1,'USIF_Full_Manufact','USIF_Full_Manufact',@Date,'USIF_Full_Manufact'
 from dbo. Portinfo
...
--Renters full
insert into dbo.Portinfo (PORTINFOID,PORTNUM,PORTNAME,CREATEDATE,DESCRIPT)
select max(portinfoid)+1,'USIF_Full_Renters','USIF_Full_Renters',@Date,'USIF_Full_Renters'
 from dbo. Portinfo
...
--Other full
insert into dbo.Portinfo (PORTINFOID,PORTNUM,PORTNAME,CREATEDATE,DESCRIPT)
select max(portinfoid)+1,'USIF_Full_Other','USIF_Full_Other',@Date,'USIF_Full_Other'
 from dbo. Portinfo
...
--Clay 21st full
insert into dbo.Portinfo (PORTINFOID,PORTNUM,PORTNAME,CREATEDATE,DESCRIPT)
select max(portinfoid)+1,'USIF_Full_Clay_21st','USIF_Full_Clay_21st',@Date,'USIF_Full_Clay_21st'
 from dbo. Portinfo
...
--Clay Homes full
insert into dbo.Portinfo (PORTINFOID,PORTNUM,PORTNAME,CREATEDATE,DESCRIPT)
select max(portinfoid)+1,'USIF_Full_Clay_Homes','USIF_Full_Clay_Homes',@Date,'USIF_Full_Clay_Homes'
 from dbo. Portinfo
