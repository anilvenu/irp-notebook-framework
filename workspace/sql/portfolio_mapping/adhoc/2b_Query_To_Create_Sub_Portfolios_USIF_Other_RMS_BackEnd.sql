...
join portacct b on a.ACCGRPID = b.ACCGRPID
where portinfoid = 3
--USERTXT2 - using this to pull out Clayton for the two exposures USIF_Other_Clay_21st & USIF_Other_Clay_Home
--CLAY
--LEND
--PROP
...
join portacct b on a.ACCGRPID = b.ACCGRPID
where portinfoid = 3
--Clay client name there - using this to pull out Clayton for the two exposures USIF_Other_Clay_21st & USIF_Other_Clay_Home
-----------------------------------------------------------------------------------------------------------------------*/
...
select max(portinfoid)+1,'USIF_Other_Lender_P','USIF_Other_Lender_P',@Date,'USIF_Other_Lender_P'
 from dbo. Portinfo
...
--CB Lender Placed
insert into dbo.Portinfo (PORTINFOID,PORTNUM,PORTNAME,CREATEDATE,DESCRIPT)
select max(portinfoid)+1,'USIF_Other_CB','USIF_Other_CB',@Date,'USIF_Other_CB'
 from dbo. Portinfo
...
insert into dbo.Portinfo (PORTINFOID,PORTNUM,PORTNAME,CREATEDATE,DESCRIPT)
select max(portinfoid)+1,'USIF_Other_Manufact','USIF_Other_Manufact',@Date,'USIF_Other_Manufact'
 from dbo. Portinfo
...
--Renters
insert into dbo.Portinfo (PORTINFOID,PORTNUM,PORTNAME,CREATEDATE,DESCRIPT)
select max(portinfoid)+1,'USIF_Other_Renters','USIF_Other_Renters',@Date,'USIF_Other_Renters'
 from dbo. Portinfo
...
--Other
insert into dbo.Portinfo (PORTINFOID,PORTNUM,PORTNAME,CREATEDATE,DESCRIPT)
select max(portinfoid)+1,'USIF_Other_Other','USIF_Other_Other',@Date,'USIF_Other_Other'
 from dbo. Portinfo
...
--Clay 21st
insert into dbo.Portinfo (PORTINFOID,PORTNUM,PORTNAME,CREATEDATE,DESCRIPT)
select max(portinfoid)+1,'USIF_Other_Clay_21st','USIF_Other_Clay_21st',@Date,'USIF_Other_Clay_21st'
 from dbo. Portinfo
...
--Clay Homes
insert into dbo.Portinfo (PORTINFOID,PORTNUM,PORTNAME,CREATEDATE,DESCRIPT)
select max(portinfoid)+1,'USIF_Other_Clay_Home','USIF_Other_Clay_Home',@Date,'USIF_Other_Clay_Home'
 from dbo. Portinfo
...
WHERE pi.PORTNAME IN (
    ...
    'USIF_Other_Renters',
    'USIF_Other_Other',
    'USIF_Other_Clay_21st',
    'USIF_Other_Clay_Home'
)
