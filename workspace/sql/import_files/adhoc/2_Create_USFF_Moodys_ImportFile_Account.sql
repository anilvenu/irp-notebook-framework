/**********************************************************************************************************************************************
Purpose: This script creates the Risk Modeler Account import file for US Fire Following exposures
...
Select * From Modeling_{{ DATE_VALUE }}_Moodys_{{ CYCLE_TYPE }}_USFF_Account
