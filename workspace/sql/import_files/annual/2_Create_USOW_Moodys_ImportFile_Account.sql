/**********************************************************************************************************************************************
Purpose: This script creates the Risk Modeler Account import file for US Severe Convective Storm exposures
...
Select * From Modeling_{{ DATE_VALUE }}_Moodys_{{ CYCLE_TYPE }}_USOW_Account
