/**********************************************************************************************************************************************
Purpose: This script creates the Risk Modeler Location import file for CB Earthquake exposures
...
Select * From Modeling_{{ DATE_VALUE }}_Moodys_{{ CYCLE_TYPE }}_CBEQ_Location
